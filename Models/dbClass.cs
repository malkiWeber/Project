...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename='H:\\Project\\CarRental\\Dal\\Data\\database.mdf';Integrated Security=True;Connect Timeout=30");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //    // הגדרת הקשרים עם Renting
        //    //entity.HasMany(e => e.Rentings)
        //    //    .WithOne()
        //    //    .HasForeignKey(r => r.CustomerId); // הנח ש-Renting מכילה CustomerId
        //});
        ...
        modelBuilder.Entity<Worker>(entity =>
        {
           ...
           // entity.HasKey(e => e.Id).HasName("PK_Worker");
            entity.Property(e => e.HoursMonth).HasColumnName("hoursMonth");
            entity.Property(e => e.RolsId).HasColumnName("rolsId");

            // הגדרת הקשר עם Role
            entity.HasOne(e => e.Rols)
                .WithMany()
                .HasForeignKey(e => e.RolsId);
        });
